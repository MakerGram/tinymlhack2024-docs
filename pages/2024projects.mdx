...
|------------------|-------------------------------------|------------------------------|-------------------------------------------------------|-------------------------------|--------------|
| Team DevScript!  | An  Tiny-ML Project which recognize babies crying voice,send notification and can remotely swigs the crib             | Jerald Joyson , Bimal Devasia , Mohamed Nishan       | [View Documentation]()        | ![](https://raw.githubusercontent.com/MakerGram/tinymlhack2024-docs/refs/heads/main/pages/2024projects/img/devscript/devscript.jpg) | 🏆 Best Product|
